...
!function(a, b) {
    ...
    n.fn = n.prototype = {
        ...
        each: function(a, b) {
            var c, d = 0;
            if (s(a)) {
                for (c = a.length; c > d; d++) if (!1 === b.call(a[d], d, a[d])) break;
                ...
                CHILD: function(a, b, c, d, e) {
                    ...
                    return 1 === d && 0 === e ? function(a) {
                        ...
                        if (q) {
                            ...
                            j = k[a] || [], n = j[0] === w && j[1], t = n), !1 === t) while (m = ++n && m && m[p] || (t = n = 0) || o.pop()) if ((h ? m.nodeName.toLowerCase() === r : 1 === m.nodeType) && ++t && (s && (l = m[u] || (m[u] = {}), 
    ...
    n.Callbacks = function(a) {
        ...
        var b, c, d, e, f = [], g = [], h = -1, i = function() {
            for (e = a.once, d = b = !0; g.length; h = -1) {
                c = g.shift();
                while (++h < f.length) !1 === f[h].apply(c[0], c[1]) && a.stopOnFalse && (h = f.length, 
                c = !1);
            }
    ...
    n.fn.ready = function(a) {
        ...
        ready: function(a) {
            (!0 === a ? --n.readyWait : n.isReady) || (n.isReady = !0, !0 !== a && --n.readyWait > 0 || (I.resolveWith(d, [ n ]), 
    ...
    n.event = {
        ...
        add: function(a, b, c, d, e) {
            ...
            if (r) {
                ...
                l = n.event.special[o] || {}, k = n.extend({
                    ...
                    namespace: p.join(".")
                }, f), (m = i[o]) || (m = i[o] = [], m.delegateCount = 0, l.setup && !1 !== l.setup.call(a, d, p, g) || a.addEventListener && a.addEventListener(o, g)), 
        ...
        off: function(a, b, c) {
            ...
            return !1 !== b && "function" != typeof b || (c = b, b = void 0), !1 === c && (c = ha), 
            this.each((function() {
    ...
    n.extend(n.event, {
        trigger: function(b, c, e, f) {
            ...
            o = n.event.special[q] || {}, f || !o.trigger || !1 !== o.trigger.apply(e, c))) {
                ...
                m = l && h[l], m && m.apply && L(h) && (b.result = m.apply(h, c), !1 === b.result && b.preventDefault());
                return b.type = q, f || b.isDefaultPrevented() || o._default && !1 !== o._default.apply(p.pop(), c) || !L(e) || l && n.isFunction(e[q]) && !n.isWindow(e) && (i = e[l], 

...
(function(e, t, n) {
    ...
    (function(e, t, n, r) {
        function T(e) {
            while (e && "undefined" != typeof e.originalEvent) e = e.originalEvent;
            return e;
        }
        function N(t, n) {
        ...
        function B(t) {
            ...
            n && 1 === n.length && (r = t.target, i = C(r), i.hasVirtualBinding && (E = w++, 
        ...
        function U(t) {
            ...
            return {
                setup: function() {
                    ...
                    var r = e.data(this, i);
                    r[t] = !0, l[t] = (l[t] || 0) + 1, 1 === l[t] && b.bind(n, H), e(this).bind(n, R), 
        ...
        e.each("touchstart touchmove touchend tap taphold swipe swipeleft swiperight scrollstart scrollstop".split(" "), (function(t, n) {
            ...
            getLocation: function(e) {
                ...
                if (0 === e.pageY && Math.floor(s) > Math.floor(e.pageY) || 0 === e.pageX && Math.floor(i) > Math.floor(e.pageX)) i -= n, 
                s -= r; else if (s < e.pageY - r || i < e.pageX - n) i = e.pageX - n, s = e.pageY - r;
                return {
                    x: i,
                    y: s
                };
            ...
            setup: function() {
                ...
                t = e.data(this, "mobile-events"), t || (t = {
                    ...
                    s.move = function(t) {
                        ...
                        r = e.event.special.swipe.stop(t), l || (l = e.event.special.swipe.handleSwipe(o, r, n, u), 
                        l && (e.event.special.swipe.eventInProgress = !1)), Math.abs(o.coords[0] - r.coords[0]) > e.event.special.swipe.scrollSupressionThreshold && t.preventDefault();
                    }, s.stop = function() {
            ...
            teardown: function() {
                var t, n;
                t = e.data(this, "mobile-events"), t && (n = t.swipe, delete t.swipe, t.length--, 
                0 === t.length && e.removeData(this, "mobile-events")), n && (n.start && e(this).off(u, n.start), 
                n.move && i.off(f, n.move), n.stop && i.off(a, n.stop));
            }
        }, e.each({

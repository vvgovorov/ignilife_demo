$((function() {
    ...
    (function() {
        var form = $(".comments-container .hbspt-form"), invalidInputs = (form.find(":input:not(button)"), 
        []);
        form.submit((function(event) {
            invalidInputs = this.querySelectorAll(":invalid");
            if (!invalidInputs.length) return true;
            invalidInputs.forEach((function(i) {
                var e = $(i), className = "invalid " + (e.attr("required") && "" === e.val() ? "required" : "not-valid");
                e.addClass("invalid");
                e.parent().addClass(className);
                e.on("input", resetValidation);
            }));
        ...
        function resetValidation() {
            ...
            e.parent().removeClass("invalid required not-valid");
            e.off("input", resetValidation);
        }
    })();
}));